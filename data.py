...
SKILLS_DB = {
    ...
    "tidal_wave":   dict(name="Tidal Wave",    element="water", type="aoe_magic", power=1.3, cost=5,
    ...
    "wind_aoe":     dict(name="Cyclone",       element="wind", type="aoe_attack", power=1.3, cost=4,
...
HEROES_DB = [
    ...
    dict(id="luna",   name="Luna",   title="Nightshade",       element="dark", rarity="SSR", role="nihility",
         ...
         ultimate="void_nova"),
    dict(id="pyra",   name="Pyra",   title="Crimson Empress",  element="fire", rarity="SSR", role="destruction",
         stats={"hp": 126, "atk": 28, "defn": 15, "spd": 15, "mp": 32},
         skills=["fire_slash", "fire_bolt", "inferno", "basic_attack"],
         ultimate="meteor"),
...
EQUIPMENT_SETS = {
    ...
    "frost":  dict(name="Frost Sovereign", items=("frost_staff", "guardian_aegis", "sage_amulet"),
                  bonus=dict(defn_pct=0.10, mp=15), desc="+10% DEF, +15 MP"),
    "void":   dict(name="Voidwalker",   items=("void_blade", "shadow_cloak", "mana_pendant"),
                  bonus=dict(atk_pct=0.08, spd=3), desc="+8% ATK, +3 SPD"),
